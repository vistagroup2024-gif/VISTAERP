  ...
  return (
    <div className="max-w-2xl space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 pb-4">
        <div>
          <h1 className="text-xl font-bold tracking-tight text-slate-900">Bill Record</h1>
          {/* The heading used to be "Sales Invoice" / "Purchase Bill", which
              read as the Sales Invoice voucher — a different screen. Which
              side you are on is what the toggle below says. */}
          <p className="text-sm text-slate-500">{kind === "customer" ? "Charge a customer" : "Record a supplier bill"}</p>
        </div>
