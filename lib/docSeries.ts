...
export const DOC_SERIES: SeriesDef[] = [
  ...
  // ── ledger entries ───────────────────────────────────────────────────────
  { key: "gl_receipt",  label: "Receipt",    kind: "ledger", defaultPrefix: "Rct:", defaultPadding: 1 },
  { key: "gl_payment",  label: "Payment",    kind: "ledger", defaultPrefix: "Pmt:", defaultPadding: 1 },
  { key: "gl_journal",  label: "Journal",    kind: "ledger", defaultPrefix: "Jrn:", defaultPadding: 1 },
  { key: "gl_contra",   label: "Contra",     kind: "ledger", defaultPrefix: "Cnt:", defaultPadding: 1 },
  { key: "gl_petty",    label: "Petty Cash", kind: "ledger", defaultPrefix: "Pty:", defaultPadding: 5 },
  { key: "gl_pdc",      label: "PDC",        kind: "ledger", defaultPrefix: "Pdc:", defaultPadding: 1 },
  { key: "gl_payroll",  label: "Payroll",    kind: "ledger", defaultPrefix: "Pay:", defaultPadding: 5 },
  { key: "journal",     label: "Car postings & system journals", kind: "ledger", defaultPrefix: "JOU-", defaultPadding: 5,
    note: "Car Invoice, Car Receipt, Car Expense, Monthly Charges and every other posting the ERP raises by itself" },
