...
export const DASHBOARD_CARDS: CardDef[] = [
  ...
  { key: "pending_sales_orders", label: "Pending Sales Orders", icon: "sales",
    hint: "Sale Orders not yet turned into a Sales Invoice or Car Invoice — a Purchase Order raised from one (the car flow's own procurement step) doesn't remove it from this card; only the customer actually being invoiced does",
    href: "/accounting/sales/orders-report" },
