...
// The Visa Invoice list, as a panel rather than a page, so the Sales Invoice
// screen can show it as a tab beside Hotel and Transport. The standalone route
// still exists and renders this same component — the two cannot drift apart.
export default async function VisaInvoicesPanel() {
