-- 226_voucher_exclude_cancelled_trips.sql
-- Vouchers must not list cancelled trips. The public transport voucher RPC listed
-- every trip of the booking; exclude cancelled ones. (The staff voucher page adds
-- the same .neq("status","cancelled") filter to its trip query.)
