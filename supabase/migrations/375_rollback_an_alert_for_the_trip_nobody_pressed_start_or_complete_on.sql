-- Rollback of 375: drop the two alert routines and put dashboard_module_metrics
-- back without the transport.alerts cell.
begin;
...
drop function if exists public.transport_trip_alert_summary();
drop function if exists public.transport_trip_alerts();
commit;
